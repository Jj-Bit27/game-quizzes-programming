...
export const getGamesUserRequest = async (id_usuario) => axios.get(`/partida/${id_usuario}`);

/* Funcion para obtener todas las partidas del quiz */
export const getGamesQuizRequest = async (id_quiz) => axios.get(`/partida/${id_quiz}`);

/* Funcion para obtener el ranking del juego */
export const getRankingRequest = async () => axios.get(`/partida/ranking`);